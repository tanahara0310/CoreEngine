...
> ⚠️ **現状の注意点:** AO Map は静的マップのみ。  
> ランタイムで生成するSSAO（→ Phase 1 実装推奨）があると動的なコンタクトシャドウが加わる。
...
|---|---|---|---|---|---|
| 1 | **sRGB 出力確認・修正** | 🔴 高 | ★☆☆ 低 | 色精度の正確化 | 1 |
| 2 | **エミッシブ → Bloom 連携** | 🔴 高 | ★☆☆ 低 | 発光素材の光り方 | 1 |
| 3 | **SSAO** | 🔴 高 | ★★☆ 中 | 接触部分の陰影・奥行き感 | 1 |
...
#### 4-3. SSAO（Screen Space Ambient Occlusion）
