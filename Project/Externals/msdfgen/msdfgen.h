...
// [CoreEngine 改変] 以下のヘッダは対応する core/*.cpp ごと削除している。
// 距離場の生成には不要なプレビュー / ファイル出力 / SVG 出力の機能:
//   render-sdf.h  rasterization.h  sdf-error-estimation.h
//   save-bmp.h  save-tiff.h  save-rgba.h  save-fl32.h
//   shape-description.h  export-svg.h
// 詳細と復元手順は USAGE_IN_COREENGINE.md を参照。
