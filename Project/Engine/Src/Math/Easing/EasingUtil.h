...
namespace EasingUtil {
    ...
    /// @brief イージング関数を適用（t・戻り値ともに 0.0～1.0）
    ...
    /// @brief RGBA カラー値（各成分 0.0～1.0）
    struct Color { float r, g, b, a; };

    /// @brief RGBA 各成分をまとめて補間
    ...
    /// @brief 複合イージング（switchPoint を境に 2 つのイージングを切り替える）
