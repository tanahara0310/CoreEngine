...
inline const WaterPresetData& GetWaterPresetData(WaterPresetType type) {
    ...
    static const WaterPresetData kLake = {
        ...
        1.4f,
        {
            { 3, 0.050f, 0.090f, 12.0f, 18.0f, 1.0f, 1.5f, 0.10f, 0.22f, 0.35f },
            { 5, 0.020f, 0.045f,  7.0f, 12.0f, 1.4f, 2.0f, 0.05f, 0.14f, 0.70f },
            { 8, 0.006f, 0.018f,  4.5f,  8.0f, 1.8f, 2.6f, 0.02f, 0.08f, 1.20f },
        },
    ...
    static const WaterPresetData kOcean = {
        ...
        1.9f,
        {
            { 4, 0.120f, 0.220f, 14.0f, 24.0f, 2.0f, 2.8f, 0.12f, 0.26f, 0.50f },
            { 5, 0.050f, 0.100f,  8.0f, 14.0f, 2.6f, 3.4f, 0.06f, 0.16f, 0.90f },
            { 7, 0.018f, 0.040f,  4.0f,  8.0f, 3.4f, 4.8f, 0.02f, 0.08f, 1.40f },
        },
        { 0.06f, 0.03f },
        { 3.0f,  3.0f  },
    };
    ...
    static const WaterPresetData kPool = {
        ...
        1.0f,
        {
            { 2, 0.015f, 0.030f, 10.0f, 14.0f, 0.7f, 1.0f, 0.04f, 0.10f, 0.18f },
            { 4, 0.006f, 0.015f,  6.5f, 10.0f, 0.9f, 1.2f, 0.02f, 0.06f, 0.45f },
            { 10, 0.002f, 0.006f, 3.5f,  6.5f, 1.0f, 1.4f, 0.01f, 0.03f, 0.90f },
        },
        { 0.02f, 0.008f },
        { 5.0f,  5.0f   },
    };
    ...
    static const WaterPresetData kRain = {
        ...
        2.2f,
        {
            { 1, 0.010f, 0.018f, 6.0f, 8.0f, 2.2f, 2.8f, 0.03f, 0.06f, 0.20f },
            { 4, 0.008f, 0.015f, 3.0f, 5.5f, 3.0f, 4.0f, 0.02f, 0.05f, 0.80f },
            { 11, 0.004f, 0.010f, 1.2f, 3.0f, 4.0f, 6.8f, 0.01f, 0.03f, 1.80f },
        },
        { 0.04f, 0.02f },
        { 6.0f,  6.0f  },
    };
